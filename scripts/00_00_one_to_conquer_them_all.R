...
# identify plots with organic soils: we have to rename it: 01_04_... 
source(paste0(here::here(),"/scripts/02_00_RG_LT_DW_inventory_plot_status_HBI.R"))

#### forest edges -------------------------------------------------------------------------------------------------------------------------------------------------------------------
# LT
georef_on_off(source(paste0(here(), "/scripts/02_01_LT_forest_edges_HBI.R")), 
              source(paste0(here(), "/scripts/02_01_LT_forest_edges_HBI.R"))
...
# RG
georef_on_off(source(paste0(here(), "/scripts/02_02_RG_forest_edges_HBI.R")), 
              source(paste0(here(), "/scripts/02_02_RG_forest_edges_HBI.R"))
              ## !!!! here one can select to work with the georefferenced or not georeffrenced plots and forest edges, default is not georefferenced
              , georefference = "not_georefferenced")


#### tree  inventory status  -------------------------------------------------------------------------------------------------------------------------------------------------------------------
source(paste0(here(), "/scripts/02_03_LT_invetory_status_HBI_BZE3.R"))
...
# LT
source(paste0(here(), "/scripts/04_01_LT_stocks_HBI.R"))
# RG
source(paste0(here(), "/scripts/04_02_RG_stocks_HBI.R"))
# DW
source(paste0(here(), "/scripts/04_03_DW_stocks_HBI.R"))


#### summarizing hectar values -------------------------------------------------------------------------------------------------------------------------------------------------------------------
source(paste0(here(), "/scripts/05_00_LT_RG_DW_summarising_hectar_values_HBI.R"))


#### biodiveristy index -------------------------------------------------------------------------------------------------------------------------------------------------------------------
source(paste0(here(), "/scripts/06_00_biodiversity_index_HBI.R"))
