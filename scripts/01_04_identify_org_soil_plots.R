...
# this is a remainance from times when we stil tired to identify plots that have organic site charaacteristics but were not characerizsed as organic in the soil assessment
# as we don´t do that anymore the filter by horizont depth and C-content are obsolete now 
