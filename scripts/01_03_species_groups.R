...
SP_names <- read.delim(file = paste0(getwd(), "/data/input/x_bart.csv"), sep = ",", dec = ".", encoding = "latin1") %>% 
...
write.csv(SP_names_com_ID_tapeS, paste0(getwd(), "/data/input/x_bart_tapeS.csv"), row.names = FALSE, fileEncoding = "UTF-8")
