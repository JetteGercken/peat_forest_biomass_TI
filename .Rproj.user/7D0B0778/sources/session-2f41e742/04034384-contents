...
try({
  BZE3_trees <- read.delim(file = here(out.path.BZE3,"BZE3_LT_update_1.csv"), sep = ",", dec = ".")
...
# write.csv2(BZE3_trees, paste0(out.path.BZE3.BZE3, paste(unique(BZE3_trees$inv)[1], "LT", "update","0", "demo", sep = "_"), ".csv"))
