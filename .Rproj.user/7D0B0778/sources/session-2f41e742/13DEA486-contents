...
write.csv(DW_removed, paste0(out.path, paste(unique(DW_inv_info$inv)[1], "DW_removed", sep = "_"), ".csv"), row.names = FALSE)



# living trees
write.csv(tree_inv_info, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "LT_inv_update_1", sep = "_"), ".csv"), row.names = FALSE)
write.csv(LT_data_stat_2, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "LT_stat_2", sep = "_"), ".csv"), row.names = FALSE)
write.csv(trees_update_0, paste0(out.path, paste(unique(trees_update_0$inv)[1], "LT_update_0", sep = "_"), ".csv"), row.names = FALSE)
write.csv(LT_CCS_to_exclude, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "LT_circles_removed", sep = "_"), ".csv"), row.names = FALSE)
write.csv(trees_removed, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "LT_removed", sep = "_"), ".csv"), row.names = FALSE)

# regeneration
write.csv(RG_loc_info, paste0(out.path, paste(unique(RG_loc_info$inv)[1], "RG_loc_update_1", sep = "_"), ".csv"), row.names = FALSE)
write.csv(RG_data_stat_2, paste0(out.path, paste(unique(RG_loc_info$inv)[1], "RG_stat_2", sep = "_"), ".csv"), row.names = FALSE)
write.csv(RG_update_1, paste0(out.path, paste(unique(RG_update_1$inv)[1], "RG_update_1", sep = "_"), ".csv"), row.names = FALSE)
write.csv(RG_removed, paste0(out.path, paste(unique(RG_loc_info$inv)[1], "RG_removed", sep = "_"), ".csv"), row.names = FALSE)
write.csv(RG_CCS_to_exclude, paste0(out.path, paste(unique(RG_loc_info$inv)[1], "RG_circles_removed", sep = "_"), ".csv"), row.names = FALSE)
...
write.csv(inv_info, paste0(out.path, paste(unique(inv_info$inv)[1], "inv_info", sep = "_"), ".csv"), row.names = FALSE)
write.csv(plots_to_exclude, paste0(out.path, paste(unique(inv_info$inv)[1], "plots_to_exclude", sep = "_"), ".csv"), row.names = FALSE)

# forest edges 
write.csv(forest_edges_update_1, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "forest_edges_update_1", sep = "_"), ".csv"), row.names = FALSE)
write.csv(forest_edges_removed, paste0(out.path, paste(unique(tree_inv_info$inv)[1], "forest_edges_removed", sep = "_"), ".csv"), row.names = FALSE)
...
stop("Notes of inventory status sorting paper start here")
